...
{ 
    ...
    /// </summary>
#if USE_GENERICS
    public interface SortedCollection<K,V> : IPersistent, IResource, ITable<V> where V:class
#else
    public interface SortedCollection : IPersistent, IResource, ITable
#endif
    { 
        ...
        V[] this[K low, K high] 
#else
        object[] this[object low, object high] 
#endif
        {
            get;
        }       
...
#else
        object[] Get(object from, BoundaryKind fromKind, object till, BoundaryKind tillKind);
#endif
