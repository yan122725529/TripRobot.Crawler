namespace Perst.Impl
{
    ...
    [Serializable]
#if USE_GENERICS
    class AltBtreeMultiFieldIndex<T>:AltBtree<object[],T>, MultiFieldIndex<T> where T:class
#else
...
#if USE_GENERICS
    class AltBtreeCaseInsensitiveMultiFieldIndex<T>:AltBtreeMultiFieldIndex<T> where T:class
#else
    class AltBtreeCaseInsensitiveMultiFieldIndex:AltBtreeMultiFieldIndex
#endif
    {
        internal AltBtreeCaseInsensitiveMultiFieldIndex() {}

#if USE_GENERICS
        internal AltBtreeCaseInsensitiveMultiFieldIndex(string[] fieldNames, bool unique) 
        : base(fieldNames, unique)
#else
        internal AltBtreeCaseInsensitiveMultiFieldIndex(Type cls, string[] fieldNames, bool unique) 
