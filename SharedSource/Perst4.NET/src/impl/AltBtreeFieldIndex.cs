namespace Perst.Impl
{
    ...
    [Serializable]
#if USE_GENERICS
    class AltBtreeFieldIndex<K,V>:AltBtree<K,V>, FieldIndex<K,V> where V:class
#else
...
#endif
    {
        ...
        internal Type cls;
        [NonSerialized()]
        internal MemberInfo mbr;
        [NonSerialized()]
        internal Type mbrType;
        ...
        protected virtual Key extractKey(object obj) 
        { 
...
#if USE_GENERICS
        public virtual bool Put(V obj) 
#else
        public virtual bool Put(object obj) 
#endif
        {
...
#if USE_GENERICS
        public virtual V Set(V obj) 
#else
        public virtual object Set(object obj) 
#endif
        {
            Key key = extractKey(obj);
            if (key == null) 
...
#if USE_GENERICS
    class AltBtreeCaseInsensitiveFieldIndex<K,V>:AltBtreeFieldIndex<K,V> where V:class
#else
    class AltBtreeCaseInsensitiveFieldIndex:AltBtreeFieldIndex
#endif
    {
        internal AltBtreeCaseInsensitiveFieldIndex()
        {
        }

#if USE_GENERICS
        internal AltBtreeCaseInsensitiveFieldIndex(String fieldName, bool unique) 
        : base(fieldName, unique)
        {
        }
#else
        internal AltBtreeCaseInsensitiveFieldIndex(Type cls, String fieldName, bool unique) 
