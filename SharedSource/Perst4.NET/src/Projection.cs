namespace Perst
{
    ...
    /// </summary>
#if USE_GENERICS
    public class Projection<From,To> :  ICollection<To>,IEnumerable where From:class where To:class
#else
    ...
    { 
        ...
        { 
            ...
            field = type.GetTypeInfo().GetDeclaredField(fieldName);
#else
...
#else
        public void Project(object[] selection) 
#endif
        { 
...
#else
        public void Project(object obj) 
#endif
        { 
            Map(obj);
        } 
...
#if USE_GENERICS
        public void Join<X>(Projection<X,To> prj) where X:class
        { 
        ...
        { 
            ...
            foreach (object p in prj.hash.Keys) 
            {
                if (hash.ContainsKey(p)) 
                { 
                    join[p] = p;
        ...
        { 
            object[] arr = new object[hash.Count];
            hash.Keys.CopyTo(arr, 0);
            return arr;
        }
#endif
