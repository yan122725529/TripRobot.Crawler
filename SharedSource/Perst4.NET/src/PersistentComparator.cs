namespace Perst
{
    ...
    /// </summary>
#if USE_GENERICS
    public abstract class PersistentComparator<K,V> : Persistent where V:class
#else
...
#else
        public abstract int CompareMembers(object m1, object m2);
#endif
...
#else
        public abstract int CompareMemberWithKey(object mbr, object key);
#endif
    }
}
